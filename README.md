...
- 在最新消息旁边加一个更顺手的小按钮
- 支持“自动在生成完成后检查，但只在缺失时提示”
- 支持多套规则预设（例如“日常剧情”“战斗场景”“成人剧情”）
- 允许指定“只补摘要，不补选项”之类的细粒度开关

## 版本号约定

- `0.1.x`：修复 bug、小幅改进交互，不改变核心用法
- `0.2.0`：增加明显的新功能，例如规则预设、消息旁快捷按钮
- `1.0.0`：当主要交互稳定、安装说明完整、经过一段时间实际使用后再考虑
